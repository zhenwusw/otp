...
allocate(#file_descriptor{module = ?MODULE, data = Port}, NewFileLength) ->
    call_port(Port, <<?RAM_FILE_ALLOCATE, NewFileLength:64/signed>>);
allocate(#file_descriptor{}, _NewFileLength) ->
    {error, enotsup}.
